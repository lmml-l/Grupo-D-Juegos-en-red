...
create (){
    ...
    this.texto = this.add.text(100, 370, "You have been disconnected from the server", { fill: '#9B111E', font: '48px Impact', align: 'center'})
    this.texto = this.add.text(350, 370, "\n\nPlease, restart this page", { fill: '#F4FFF3', font: '32px Impact', align: 'center'});
